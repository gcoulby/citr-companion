// Web Crypto helpers for AES-GCM encrypted .citr files.
// Format: magic(4) | salt(16) | iv(12) | ciphertext
// Key derivation: PBKDF2-SHA256, 300 000 iterations → AES-256-GCM

const MAGIC = new Uint8Array([0x43, 0x52, 0x30, 0x31]); // "CR01"
...
/** Returns true if the ArrayBuffer starts with the CR01 magic header. */
...
/**
 * Decrypts an encrypted .citr blob.
