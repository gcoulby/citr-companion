    ...
    <div className="fixed inset-0 bg-[#0d1117] flex items-center justify-center z-50">
      <div className="bg-[#161b22] border border-[#30363d] rounded-lg p-10 w-120 shadow-2xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-amber-400 text-xs font-mono uppercase tracking-widest">Caught in the Rain</span>
        </div>
        <h1 className="text-[#e6edf3] text-2xl font-bold mb-2">Case Board</h1>
        <p className="text-[#8b949e] text-sm mb-8">A companion for the solo mystery RPG. Offline. No telemetry.</p>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <span className="text-[11px] text-[#8b949e]">.citr file</span>
          </button>
          <button
